-- Assignment 1 SQL by Michael Zhang
...
SELECT Name + '-' + Color AS 'Name.Color' FROM Production.Product
WHERE Color IS NOT NULL;
...
SELECT TOP 6 'NAME: ' + Name + ' -- COLOR: ' + Color AS 'Name.Color' FROM Production.Product
